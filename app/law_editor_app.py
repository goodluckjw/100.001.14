...
st.markdown("<h1 style='font-size:20px;'>📘 부칙개정 도우미 (100.001.14)</h1>", unsafe_allow_html=True)
...
with st.expander("ℹ️ 사용법 안내"):
    st.markdown(
        ...
        "  1. **검색 기능**: 법령에서 특정 단어 또는 문장이 포함된 조문을 탐색합니다.\n"
        "     - 문장 검색 시 큰 따옴표는 필요하지 않습니다.\n"
        "     - 단일검색어 기반입니다. 다중검색어 또는 논리연산자(AND, OR, NOT 등)는 지원하지 않습니다. 업데이트 중입니다.\n" 
